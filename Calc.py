...
def calc4(l, w, d, c):
    ...
    D4mid=(w*c*b*(4*l-4*b**2/l-c**2/l) *midPoints-4*midPoints**3/l+(midPoints-d)**4/(b*c))/24

    M4right=w*c*a*(1-rightPoints/l)
    D4right=w*c*(4*b*(l-b**2/l)*rightPoints-4*b*rightPoints**3/l+4*(rightPoints-a)**3-a*c**2*(1-rightPoints/l))/24
